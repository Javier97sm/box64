...
EXPORT uintptr_t GetX64FunctionAddress(elfheader_t* elf_header, const char* funcname)
{
    ...
    return x64_symbol_addr;
}

EXPORT uintptr_t RunX64Function(uintptr_t x64_symbol_addr, int nargs, ...)
{
    va_list va;
    va_start(va, nargs);
